...
T=10;
path='D:\yhy\study\諺最\傻悝ぶ20狦\research\yhydata\桉噩\FeetBeat-8DF7\2020-07-28_151247';
q=[path,'.ch2' ];
% 案ch0-ch4
%------ch0------
...
title('Ionic sensor pressure - Talking','FontWeight','bold','FontSize',18)
% ylabel('Pressure (mmHg)','FontWeight','bold','FontSize',16)
xlabel('Second','FontWeight','bold','FontSize',16)
xlim([0 70])
subplot(2, 1, 2);
